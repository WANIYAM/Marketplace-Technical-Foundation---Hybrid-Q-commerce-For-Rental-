  ...
  return (
    <div className="p-4 w-full h-auto">
      ...
      <div className="flex justify-between items-center py-2">
        ...
        {/* Desktop Right Section (Links and Icons) */}
        <div className="hidden md:flex items-center gap-6">
          <Link href="/about-us" className="text-[#726E8D]">About Us</Link>
          <Link href="/contact" className="text-[#726E8D]">Contact</Link>
          <Link href="/blog" className="text-[#726E8D]">Blog</Link>
      ...
      >
        ...
        <ul className="flex flex-col md:flex-row justify-center items-start md:items-center gap-6 text-[#726E8D] text-base p-6 md:p-0">
